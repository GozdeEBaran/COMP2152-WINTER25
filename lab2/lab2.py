...
# is_strong_player = (combatStrength + healthPoints) >= 15
# print("--- You have a strong player: " + str(is_strong_player))
...
# Roll the dice for the weapon
weaponRoll = random.randint(1, 6)
herosWeapon = weapons[weaponRoll - 1]
combatStrength += weaponRoll  # Add weapon roll to hero's combat strength

# Display weapon and strength details
print(f"You rolled {weaponRoll} and got the weapon: {herosWeapon}")
if weaponRoll <= 2:
...
# Simplified combat message
print(f"Your combat strength is now: {combatStrength}")
